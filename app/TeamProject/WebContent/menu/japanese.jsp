...
<li><a href="japanese_chobab.jsp" onclick="" data-seq="1" data="11F">
...
<li><a href="japanese_yaki.jsp" onclick="" data-seq="1" data="11F">
								<div class="tmb" ><img src="<%=article.getFileimage()%>" alt="1!"> 
								  </div>							
								<div class="con">
									<strong class="tit">	<%=article.getSubject()%></strong>
...
<li><a href="japanese_kuka.jsp" onclick="" data-seq="1" data="11F">
								<div class="tmb" ><img src="<%=article.getFileimage()%>" alt="1!"> 
								  </div>							
								<div class="con">
									<strong class="tit">	<%=article.getSubject()%></strong>
