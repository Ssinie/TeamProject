...
<input type ="button" value="메뉴 소개" onclick="window.location='/TeamProject/menu/Korean.jsp?id=<%=id %>'" />
...
<input type ="button" value="예약 및 확인" onclick="window.location='/TeamProject/Reserve/ReserveForm.jsp'" />
