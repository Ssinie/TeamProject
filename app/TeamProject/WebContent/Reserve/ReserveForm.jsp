...
<form method = "get" action = "ReservePro.jsp">
	<fieldset>
			...
			<input type = "text" name = "guest" id = "sub"> <br>
			<label for = "phone"> 휴대폰:</label>
			<input type = "tel" name = "tell" id = "phone" placeholder= "010-****-****">
				
			예약인원:
			<select name = "person_no" size="1">
		...
		<fieldset>
				...
				<input type = "time" name = "reservation_time" min="09:00" max="20:00"/><br>
